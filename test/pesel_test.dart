...
void main() {
  ...
  group('Pesel().toString()', () {
    test('returns PESEL number formatted to String',
        () => expect(Pesel('11111111111').toString(), equals('11111111111')));
  });

  group('Pesel().isValid', () {
    test('returns true', () => expect(Pesel('22291028314').isValid, isTrue));
    test('returns false', () => expect(Pesel('12345678901').isValid, isFalse));
  });
